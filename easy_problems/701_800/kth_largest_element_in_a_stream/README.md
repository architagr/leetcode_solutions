...
of test scores and continuously returns the `kth` highest test score **after** a new
score has been submitted. More specifically, we are looking for the `kth` highest score
