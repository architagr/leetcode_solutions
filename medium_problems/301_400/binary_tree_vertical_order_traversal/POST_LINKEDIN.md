...
group by it. That's a coordinate carried down the traversal, same as Day 29's depth, except
this one goes negative.

The interesting part is that this one has to be BFS, and Day 29's did not.

Day 29 grouped by depth, and the required left-to-right order within a level came from
